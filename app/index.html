...
<!-- End Google Tag Manager -->
    ...
    <meta property="og:site_name" content="Rezart Agency"/>
    <meta property="og:title" content="Rezart Agency | Как получить максимум от маркетинга" />
    <meta property="og:url" content="http://rezart.agency/mk/"/>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 header">
                ...
                <a target="_blank" href="https://goo.gl/maps/pfmWhnoq33p"><p class="info">18 марта 2017 г, 11:00 <br /> Киев, ул Коновальца <br /> д 36д, 8 этаж</p></a>
                <div class="clear"></div>
            </div>
            <div class="col-12 tc">
        ...
        <div class="row">
            ...
            <div id="anchor_form" class="col-6 clearfix">
                <div class="form_block">
                    <form method="POST" class="form-inline db-form" action="javascript:void(null);">
                       ...
                       <input type="hidden" name="affiliate_id" value="<?php echo $data['affiliate_id']; ?>">
                        ...
                        <span class="input field">
                            <input id="name_01" required="" class="form-control name input__field " type="text" name="entry.906276550" />
                        ...
                        <span class="input field">
                            ...
                            <label class="input__label" for="tel_01">
                                <span class="input__label-content">Ваш номер телефона</span>
                            </label>
                        </span>

                        <span class="input field">
                            <input id="mail_01" required="" class="form-control name input__field" type="email" name="entry.1158701611" />
                    ...
                    <div class="text--sm"><span>*</span> Ваши данные никогда не будут переданы 3-м лицам</div>
                </div>
            </div>
        </div>
    </div>
...
<div id="sec_03">
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h2 class="text--title">Почему мастер-класс от Rezart Agency — <br /> №1 в Вашем «tо do» листе? </h2>
                <p class="block_text">Это уникальные знания, родившиеся из личного опыта команды Rezart Agency <br /> Вы <span class="text--title text--hl">научитесь монетизировать возможности и знания сотрудников на 101%</span></p>
            </div>
            <div class="col-4">
                <img src="img/bl3_img1.png" alt="Rezart первый в списке задач" class="sec_img">
            </div>
        </div>
    </div>
</div>
...
<div id="sec_04">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text--title">Какие бизнес-темы мы разберем вместе с Вами на встрече? </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-5">
            ...
            <div class="col-7">
                ...
                <p class="block_text">За 3 часа живого общения с Игорем Головко и Евгением Шевченко <br /> Вы узнаете первыми о <span class="text--title">реальных способах закрытия болевых точек</span> <br /> в бизнесе и сможете внедрить у себя: </p>
                <ul class="item_list">
                    <li>Маркетинг. Customer Journey. KPI отдела маркетинга</li>
                    <li>Стоимость каждого сотрудника. Как экономить. Экосистема аналитики</li>
                    <li>Воронки больше не продают. Почему? Что делать</li>
                    <li>Коммуникация бренда</li>
                </ul>
            </div>
        </div>
    </div>
...
<div id="sec_05">
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h2 class="text--title">Всего через 3 часа живого общения <br /> Вы узнаете о решении Ваших бизнес-болей: </h2>
                <ul class="item_list fst_col">
                    <li>Нет заказов, мало клиентов, <br /> убытки, работа в 0 или минус</li>
                    <li>Нет портрета идеального клиента,  <br /> не настроены цели</li>
                    <li>Понимание того, что компания <br /> катится вниз, отстала от рынка <br /> и тенденций, конкуренты опережают</li>
                </ul>
                <ul class="item_list scnd_col">
                    <li>Большие затраты  <br /> на маркетинг/рекламу</li>
                    <li>Нет аналитики и показателей эффективности,  <br /> нет прогнозируемой прибыли</li>
                    <li>Вы погрязли в операционке,  <br /> все делите вручную или в excel файлах, <br /> нет отдела маркетинга в компании,  <br /> нет интернет-маркетинга</li>
                </ul>
            </div>
            <div class="col-4">
                <img src="img/bl5_img1.png" alt="Решение проблем в бизнесе" class="sec_img-1">
            </div>
        </div>
    </div>
</div>
...
<div id="sec_08">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text--title">Делиться опытом будут</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                <div class="coach_item">
                    <img src="img/bl6.1_img1.jpeg" alt="" class="coach_img">
                    <div class="coach_description">
                        <p class="coach_name title text--title">Евгений Шевченко</p>
                        <p class="coach_prof text--title">Консультант по маркетингу и продажам</p>
                        <p class="block_text"><span class="text--title">2012-2015</span> — маркетолог в «E-com» (Лидирующая платформа <br /> по электронному документообороту для ритейл-сетей СНГ) </p>
                        <p class="block_text"><span class="text--title">2015</span> — директор по маркетингу в «Бизнес-Конструктор» </p>
                        <p class="block_text"><span class="text--title">2016</span> — руководитель консалтингового бюро WillCatchFire</p>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="coach_item">
                    <img src="img/bl6.1_img2.jpeg" alt="" class="coach_img">
                    <div class="coach_description">
                        <p class="coach_name title text--title">Игорь Головко</p>
                        <p class="coach_prof text--title">Управляющий Rezart Digital Agency</p>
                        <p class="block_text"><span class="text--title">2011-2014</span> — digital-manager в канадской компании Wenco International Mining Systems (системы автоматизации предприятий)</p>
                        <p class="block_text"><span class="text--title">2014-2016</span> — управляющий Genius Studio, подразделения по разработке интернет-решений в Genius Marketing (более 900 реализованных проектов, 50+ сотрудников)</p>
                        <p class="block_text"><span class="text--title">2016-2017</span> — владелец и управляющий digital-marketing агентства Rezart</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form  method="POST" class="form-inline db-form" action="javascript:void(null);">
                      ...
                      <input type="hidden" name="affiliate_id" value="<?php echo $data['affiliate_id']; ?>">
                       ...
                       <!-- END Hidden Required Fields -->
                        ...
                        <span class="input field">
                            <input id="tel_02" required="" class="form-control name input__field" type="tel" name="entry.712604779"  />
                        ...
                        <span class="input field">
                            <input id="mail_02" required="" class="form-control name input__field" type="email" name="entry.1158701611" />
