if (localStorage.name && localStorage.email)  {
  ...
  $('input[name="entry.1634749921"]').val(localStorage.companie);
...
$(function() {
  $("[name=send]").click(function (e) {
   ...
   localStorage.name = form.find('input[name="entry.906276550"]').val();
   localStorage.companie = form.find('input[name="entry.1634749921"]').val();
